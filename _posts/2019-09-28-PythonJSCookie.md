---
title:Python爬虫—破解JS加密的Cookie
date: 2019-09-26 22:46:49
---
# Python爬虫—破解JS加密的Cookie

在GitHub上维护了一个[代理池](https://link.zhihu.com/?target=https%3A//github.com/jhao104/proxy_pool)的项目，代理来源是抓取一些免费的代理发布网站。上午有个小哥告诉我说有个代理抓取接口不能用了，返回状态521。抱着帮人解决问题的心态去跑了一遍代码。发现果真是这样。

　　通过Fiddler抓包比较，基本可以确定是JavaScript生成加密Cookie导致原来的请求返回521。

打开Fiddler软件，用浏览器打开目标站点([http://www.kuaidaili.com/proxylist/2/](https://link.zhihu.com/?target=http%3A//www.kuaidaili.com/proxylist/2/)) 。可以发现浏览器对这个页面加载了两次，第一次返回521，第二次才正常返回数据。很多没有写过网站或是爬虫经验不足的童鞋，可能就会觉得奇怪为什么会这样？为什么浏览器可能正常返回数据而代码却不行？

![img](https://pic2.zhimg.com/80/v2-c58263d24c184a64d24a79482f60e10d_hd.png)
...
![img](https://pic4.zhimg.com/80/v2-d5282f09a023a778b4e4d632a2e242e7_hd.png)
...
![img](https://pic1.zhimg.com/80/v2-f7c0359f7ac97212e6e5d2df7cc7fde4_hd.png)
...
　　下面是完整[代码](https://link.zhihu.com/?target=https%3A//github.com/jhao104/memory-notes/blob/master/Python/Python%E7%88%AC%E8%99%AB%E2%80%94%E7%A0%B4%E8%A7%A3JS%E5%8A%A0%E5%AF%86%E7%9A%84Cookie.md):
